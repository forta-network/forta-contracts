...
*/
abstract contract NodeRunnerRegistryEnable is NodeRunnerRegistryManaged {
    ...
    */
    function isEnabled(address scanner) public view virtual returns (bool) {
        return isScannerRegistered(scanner) &&
            !isDisabled(scanner) &&
            _isStakedOverMin(scannerAddressToId(scannerId)); 
    }
