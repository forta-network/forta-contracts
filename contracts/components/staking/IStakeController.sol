...
interface IStakeController {
    ...
    function setStakeSubjectHandler(uint8 subjectType, address subjectHandler) external;
    function getStakeSubjectHandler(uint8 subjectType) external view returns(address);
