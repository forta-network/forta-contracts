...
// Bot Execution
bytes32 constant BOT_UNITS_ADMIN_ROLE = keccak256("BOT_UNITS_ADMIN_ROLE");
bytes32 constant BOT_UNITS_CAPACITY_ADMIN_ROLE = keccak256("BOT_UNITS_CAPACITY_ADMIN_ROLE");
bytes32 constant BOT_ACTIVE_UNITS_ADMIN_ROLE = keccak256("BOT_ACTIVE_UNITS_ADMIN_ROLE");
bytes32 constant INDIVIDUAL_LOCK_ADMIN_ROLE = keccak256("INDIVIDUAL_LOCK_ADMIN_ROLE");
bytes32 constant TEAM_LOCK_ADMIN_ROLE = keccak256("TEAM_LOCK_ADMIN_ROLE");
bytes32 constant PUBLIC_GOOD_ADMIN_ROLE = keccak256("PUBLIC_GOOD_ADMIN_ROLE");
bytes32 constant FREE_TRIAL_ADMIN_ROLE = keccak256("FREE_TRIAL_ADMIN_ROLE");
bytes32 constant EXECUTION_FEES_ADMIN_ROLE = keccak256("EXECUTION_FEES_ADMIN_ROLE");