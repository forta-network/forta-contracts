    ...
    before(async function () {
        ...
        await Promise.all(
            [
                ...
                this.access.connect(this.accounts.admin).grantRole(this.roles.SUBSCRIPTION_ADMIN, this.accounts.manager.address),
                this.access.connect(this.accounts.admin).grantRole(this.roles.AGENT_UNITS_CAPACITY_ADMIN, this.subscriptionManager.address),
                this.access.connect(this.accounts.admin).grantRole(this.roles.AGENT_ACTIVE_UNITS_ADMIN, this.agents.address),
                this.access.connect(this.accounts.admin).grantRole(this.roles.INDIVIDUAL_LOCK, this.individualLock.address),
                this.access.connect(this.accounts.admin).grantRole(this.roles.TEAM_LOCK, this.teamLock.address),
                ...
                this.agents.connect(this.accounts.manager).setAgentUnits(this.agentUnits.address),
