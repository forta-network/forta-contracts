...
describe('Forta Staking', function () {
  ...
  describe('Deposit / Withdraw', function () {
    describe('no delay', function () {
      it('happy path', async function () {
        ...
        const tx1       = await this.modules.staking.connect(this.accounts.user1).scheduleWithdrawal(subject1, '50');
        const deadline1 = await txTimestamp(tx1);
        await expect(tx1)
          .to.emit(this.modules.staking, 'WithdrawalSheduled').withArgs(subject1, this.accounts.user1.address, '50', deadline1);
        ...
        await expect(this.modules.staking.connect(this.accounts.user1).withdraw(subject1))
          ...
          .to.emit(this.modules.staking, 'WithdrawalSheduled').withArgs(subject1, this.accounts.user1.address, '0', 0);
        ...
        const tx2       = await this.modules.staking.connect(this.accounts.user2).scheduleWithdrawal(subject1, '100');
        const deadline2 = await txTimestamp(tx2);
        await expect(tx2)
          .to.emit(this.modules.staking, 'WithdrawalSheduled').withArgs(subject1, this.accounts.user2.address, '100', deadline2);
        ...
        await expect(this.modules.staking.connect(this.accounts.user2).withdraw(subject1))
          ...
          .to.emit(this.modules.staking, 'WithdrawalSheduled').withArgs(subject1, this.accounts.user2.address, '0', 0);
  ...
  describe('Rewards', function () {
    ...
    it('decrease shares', async function () {
      ...
      await expect(this.modules.staking.connect(this.accounts.user1).scheduleWithdrawal(subject1, '50')).to.be.not.reverted;
  ...
  describe('Freezing', function () {
    ...
    it('freeze → withdraw', async function () {
      ...
      await expect(this.modules.staking.connect(this.accounts.slasher).freeze(subject1, true))
        ...
        await expect(this.modules.staking.connect(this.accounts.user1).scheduleWithdrawal(subject1, '100')).to.be.not.reverted;
        await expect(this.modules.staking.connect(this.accounts.user1).withdraw(subject1))
  ...
  describe('Slashing', function () {
    ...
    it('slashing → withdraw', async function () {
      ...
      await expect(this.modules.staking.connect(this.accounts.user2).scheduleWithdrawal(subject1, '50')).to.be.not.reverted;
      await expect(this.modules.staking.connect(this.accounts.user2).withdraw(subject1))
        .to.emit(this.token, 'Transfer').withArgs(this.modules.staking.address, this.accounts.user2.address, '40');
    ...
    it('slashing → deposit', async function () {
      ...
      await expect(this.modules.staking.connect(this.accounts.user3).scheduleWithdrawal(subject1, '75')).to.be.not.reverted;
